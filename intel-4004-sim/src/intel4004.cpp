...
void Intel4004::print_status()
{
    ...
    std::cout << "LEVEL 1 " << u_int16_to_string(sr[0]) << "          R2 R3 " << u_int8_to_string(registers[2]) << " "<< u_int8_to_string(registers[3]) <<"  RA RB " << u_int8_to_string(registers[0xA]) << " "<< u_int8_to_string(registers[0xB]) <<"\n";
    std::cout << "LEVEL 2 " << u_int16_to_string(sr[1]) << "          R4 R5 " << u_int8_to_string(registers[4]) << " "<< u_int8_to_string(registers[5]) <<"  RC RD " << u_int8_to_string(registers[0xC]) << " "<< u_int8_to_string(registers[0xD]) <<"\n";
    std::cout << "LEVEL 3 " << u_int16_to_string(sr[2]) << "          R6 R7 " << u_int8_to_string(registers[6]) << " "<< u_int8_to_string(registers[7]) <<"  RE RF " << u_int8_to_string(registers[0xE]) << " "<< u_int8_to_string(registers[0xF]) <<"\n";
    std::cout << "\n";
