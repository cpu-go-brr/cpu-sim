define("ace/mode/general_assembly_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    "use strict"; var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        this.$rules =
    {
        start: [
            { token: "keyword.control.assembly", regex: "\\b(?:${INSTRUCTIONS})\\b", caseInsensitive: !0 },
            { token: "variable.parameter.register.assembly", regex: "\\b(?:${REGISTER})\\b", caseInsensitive: !0 },
