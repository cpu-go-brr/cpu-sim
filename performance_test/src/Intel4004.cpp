...
{
{
const AddressInfo __addr_infos[2] = {PM,PL};
set((rom(get(PC)+1)), 2,__addr_infos);
}
}
...
set((get(R0)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R1)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R2)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R3)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R4)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R5)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R6)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R7)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R8)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R9)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R10)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R11)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R12)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R13)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R14)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(R15)+get(ACC)+get(CY)), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R0,ACC};
set(((get(ACC),get(R0))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R1,ACC};
set(((get(ACC),get(R1))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R2,ACC};
set(((get(ACC),get(R2))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R3,ACC};
set(((get(ACC),get(R3))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R4,ACC};
set(((get(ACC),get(R4))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R5,ACC};
set(((get(ACC),get(R5))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R6,ACC};
set(((get(ACC),get(R6))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R7,ACC};
set(((get(ACC),get(R7))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R8,ACC};
set(((get(ACC),get(R8))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R9,ACC};
set(((get(ACC),get(R9))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R10,ACC};
set(((get(ACC),get(R10))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R11,ACC};
set(((get(ACC),get(R11))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R12,ACC};
set(((get(ACC),get(R12))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R13,ACC};
set(((get(ACC),get(R13))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R14,ACC};
set(((get(ACC),get(R14))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
/* (ACC, R{R}) --> R{R}, ACC*/
{
const AddressInfo __addr_infos[2] = {R15,ACC};
set(((get(ACC),get(R15))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ACC --> ram((CM, SRC))*/
set((get(ACC)), ram((get(CM),get(SRC))));
/* PC+1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ACC --> ram_port((CM, SRC_CHIP))*/
set((get(ACC)), ram_port((get(CM),get(SRC_CHIP))));
/* PC+1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ACC --> ram_status((CM, X2, 0b01))*/
set((get(ACC)), ram_status((get(CM),get(X2),bitset(1,2))));
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ACC --> ram_status((CM, X2, 0b10))*/
set((get(ACC)), ram_status((get(CM),get(X2),bitset(2,2))));
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ACC --> ram_status((CM, X2, 0b11))*/
set((get(ACC)), ram_status((get(CM),get(X2),bitset(3,2))));
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set(((~ram((get(CM),get(SRC)))+get(ACC)+~get(CY))), 2,__addr_infos);
}
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ram_status((CM, X2, 0b00)) --> ACC*/
set((ram_status((get(CM),get(X2),bitset(0,2)))), ACC);
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ram_status((CM, X2, 0b01)) --> ACC*/
set((ram_status((get(CM),get(X2),bitset(1,2)))), ACC);
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ram_status((CM, X2, 0b10)) --> ACC*/
set((ram_status((get(CM),get(X2),bitset(2,2)))), ACC);
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
/* ram_status((CM, X2, 0b11)) --> ACC*/
set((ram_status((get(CM),get(X2),bitset(3,2)))), ACC);
/* PC +1 --> PC*/
set((get(PC)+1), PC);
}
...
{
const AddressInfo __addr_infos[2] = {CY,ACC};
set((get(ACC)+0b1111), 2,__addr_infos);
}
/* PC+1 --> PC*/
set((get(PC)+1), PC);
}
...
void Intel4004::bin(AddressInfo info, char* addr)
{
       get(info).bin(addr);
    }
void Intel4004::hex(AddressInfo info, char* addr)
{
       get(info).hex(addr);
    }
void Intel4004::dec(AddressInfo info, char* addr)
{
       get(info).dec(addr);
    }
char* Intel4004::display()
{
if(str == NULL)
{
str = (char*)malloc(247);
...
"\"ACC\":{\"bits\":4,\"val\":" + std::to_string(get(ACC).val()) + "},"
"\"CY\":{\"bits\":1,\"val\":" + std::to_string(get(CY).val()) + "},"
"\"REGISTER\":{"
"\"P0\":{"
"\"R0\":{\"bits\":4,\"val\":" + std::to_string(get(R0).val()) + "},"
"\"R1\":{\"bits\":4,\"val\":" + std::to_string(get(R1).val()) + "}"
"},"
"\"P1\":{"
"\"R2\":{\"bits\":4,\"val\":" + std::to_string(get(R2).val()) + "},"
"\"R3\":{\"bits\":4,\"val\":" + std::to_string(get(R3).val()) + "}"
"},"
"\"P2\":{"
"\"R4\":{\"bits\":4,\"val\":" + std::to_string(get(R4).val()) + "},"
"\"R5\":{\"bits\":4,\"val\":" + std::to_string(get(R5).val()) + "}"
"},"
"\"P3\":{"
"\"R6\":{\"bits\":4,\"val\":" + std::to_string(get(R6).val()) + "},"
"\"R7\":{\"bits\":4,\"val\":" + std::to_string(get(R7).val()) + "}"
"},"
"\"P4\":{"
"\"R8\":{\"bits\":4,\"val\":" + std::to_string(get(R8).val()) + "},"
"\"R9\":{\"bits\":4,\"val\":" + std::to_string(get(R9).val()) + "}"
"},"
"\"P5\":{"
"\"R10\":{\"bits\":4,\"val\":" + std::to_string(get(R10).val()) + "},"
"\"R11\":{\"bits\":4,\"val\":" + std::to_string(get(R11).val()) + "}"
"},"
"\"P6\":{"
"\"R12\":{\"bits\":4,\"val\":" + std::to_string(get(R12).val()) + "},"
"\"R13\":{\"bits\":4,\"val\":" + std::to_string(get(R13).val()) + "}"
"},"
"\"P7\":{"
"\"R14\":{\"bits\":4,\"val\":" + std::to_string(get(R14).val()) + "},"
"\"R15\":{\"bits\":4,\"val\":" + std::to_string(get(R15).val()) + "}"
"}"
"},"
"\"PC\":{"
"\"PL\":{\"bits\":4,\"val\":" + std::to_string(get(PL).val()) + "},"
"\"PM\":{\"bits\":4,\"val\":" + std::to_string(get(PM).val()) + "},"
"\"PH\":{\"bits\":4,\"val\":" + std::to_string(get(PH).val()) + "}"
"},"
"\"CM\":{\"bits\":3,\"val\":" + std::to_string(get(CM).val()) + "},"
"\"STACK\":{"
"\"STACK0\":{\"bits\":12,\"val\":" + std::to_string(get(STACK0).val()) + "},"
"\"STACK1\":{\"bits\":12,\"val\":" + std::to_string(get(STACK1).val()) + "},"
"\"STACK2\":{\"bits\":12,\"val\":" + std::to_string(get(STACK2).val()) + "}"
"},"
"\"SRC\":{"
"\"X2\":{"
"\"SRC_CHIP\":{\"bits\":2,\"val\":" + std::to_string(get(SRC_CHIP).val()) + "},"
"\"SRC_REG\":{\"bits\":2,\"val\":" + std::to_string(get(SRC_REG).val()) + "}"
"},"
"\"X3\":{"
"\"SRC_ADDR\":{\"bits\":4,\"val\":" + std::to_string(get(SRC_ADDR).val()) + "}"
"}"
"},"
"\"TEST\":{\"bits\":1,\"val\":" + std::to_string(get(TEST).val()) + "}},\"external\":{"
"\"rom\":{\"bits\":8,\"vals\":[";
for(size_t i = 0; i < 4096; i++) json += std::to_string(rom_mem[i].val()) + ",";
...
json = json.substr(0,json.size()-1);
json += "]},";
json +="\"ram_status\":{\"bits\":4,\"vals\":[";
for(size_t i = 0; i < 512; i++) json += std::to_string(ram_status_mem[i].val()) + ",";
json = json.substr(0,json.size()-1);
json += "]},";
json +="\"ram_port\":{\"bits\":4,\"vals\":[";
for(size_t i = 0; i < 32; i++) json += std::to_string(ram_port_mem[i].val()) + ",";
json = json.substr(0,json.size()-1);
json += "]},";
json +="\"rom_port\":{\"bits\":4,\"vals\":[";
for(size_t i = 0; i < 16; i++) json += std::to_string(rom_port_mem[i].val()) + ",";
json = json.substr(0,json.size()-1);
json += "]"
"}}";
return json + "}";
